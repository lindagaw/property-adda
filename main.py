...
regressor.add(LSTM(units = 256*2, return_sequences = True, input_shape = (1, 18)))
regressor.add(Dropout(0.2))
regressor.add(LSTM(units = 512*2, return_sequences = True))
regressor.add(Dropout(0.2))
regressor.add(LSTM(units = 1024*2, return_sequences = True))
regressor.add(Dropout(0.2))
regressor.add(LSTM(units = 512*2, return_sequences = True))
regressor.add(Dropout(0.2))
regressor.add(LSTM(units = 256*2))
regressor.add(Dropout(0.2))
